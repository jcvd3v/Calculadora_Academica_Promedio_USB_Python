# Sistema de Calificaciones USB. Sumar calificaciones USB y Creditos Inscritos. Calcular el promedio actual.  Identifica Estado de PP. Modifica nota y creditos de materia.
# Features a desarrollar: Agregar Interfaz Grafica, Estadisticas de Materias o ramas Fuertes Y debiles.
